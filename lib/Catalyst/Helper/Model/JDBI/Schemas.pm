package Catalyst::Helper::Model::JDBI::Schemas;
...
use strict;
use warnings;
use base 'Catalyst::Model::JDBI::Schemas';

#### You can hard-code your configure here,
...
[% class %] - Catalyst JDBI::Schemas Model
...
L<Catalyst::Model::JDBI::Schemas> Model using schemas under L<[% schema_base %]>.
...
A Record/Schema class for L<Catalyst::Model::JDBI::Schemas> Model.
...
A Collection class for L<Catalyst::Model::JDBI::Schemas> Model.
